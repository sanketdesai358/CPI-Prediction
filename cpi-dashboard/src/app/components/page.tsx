...
export default function ComponentsPage() {
  ...
  return (
    <>
      <PageTitle eyebrow="Past month components" title={`${formatMonth(data.refMonth)} Components`}>
        Tile size follows current price-updated relative importance. Color follows the {formatMonth(data.refMonth)} inflation rate.
